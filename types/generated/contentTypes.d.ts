...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fecha_hora_inicio: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::evento.evento'
    > &
      Schema.Attribute.Private;
    nombre_evento: Schema.Attribute.String;
    noticias: Schema.Attribute.Relation<'manyToMany', 'api::noticia.noticia'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNoticiaNoticia extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cuerpo_dinamico: Schema.Attribute.DynamicZone<
      [
        'bloques-noticia.bloque-video',
        'bloques-noticia.bloque-texto',
        'bloques-noticia.bloque-imagen',
      ]
    >;
    eventos: Schema.Attribute.Relation<'manyToMany', 'api::evento.evento'>;
    fecha_de_publicacion: Schema.Attribute.DateTime;
